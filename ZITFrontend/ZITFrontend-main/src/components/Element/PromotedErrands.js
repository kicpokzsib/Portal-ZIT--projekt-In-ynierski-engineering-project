...
export class PromotedErrands extends Component {
  keyToken;
  constructor(props) {
    super(props);
    this.state = {
  ...
  refreshList() {
    fetch(variables.API_URL + "errands/promoted/new", {
      method: "GET",
      headers: {
        ...
        <>
          <div class="errands-list">
            <div class="container">
              ...
              <Row className="g-4">
                <Link to={"/dostepnezlecenia"} className="btn btn-primary">
                  Więcej
                </Link>
              </Row>
            </div>
...
export default PromotedErrands;
